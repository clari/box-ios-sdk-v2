...
- (void)refreshData
{
    ...
    [fieldsDictionnary setObject:[NSNumber numberWithInteger:self.currentPage * self.numberOfItemsPerPage] forKey:@"limit"];
    [fieldsDictionnary setObject:[NSNumber numberWithInteger: (self.currentPage - 1) * self.numberOfItemsPerPage ] forKey:@"offset"];
